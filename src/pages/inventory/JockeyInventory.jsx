...
export default function JockeyInventory() {
    ...
    const downloadPDF = () => {
        ...
        finalizePDF(doc, "Jockey Inventory Report", infoLeft, infoRight);

        doc.save("jockey_inventory.pdf");
    };
                ...
                {loading ? (
                    ...
                    <table className="w-full text-sm">
                        <thead>
                            ...
                            >
                                {["Barcode", "Style Code", "Product Code", "Size", "Quantity", "MRP", "Date"].map((h) => (
                        ...
                        <tbody>
                            ...
                            {filteredProducts.length === 0 && !loading && (
                                <tr>
                                    <td colSpan={7} className="py-12 text-center text-sm text-white/35 font-medium">
